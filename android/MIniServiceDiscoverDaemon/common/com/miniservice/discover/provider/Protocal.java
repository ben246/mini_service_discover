...
public class Protocal {
    ...
    public final static String SERVICE_NO_FOUND = "service no found";
    ...
    public byte[] getRegisterPkt(ServiceInfo info){
        ...
        Map map = new HashMap();
        map.put("device_name", info.dev);
        map.put("service_name", info.name);
        map.put("ip", info.ip);
        ...
        //Log.i(TAG, "getRegisterPkt json:"+jsonData.toString()+" len="+jsonData.toString().length()+" checksum:"+head.checksum);
    ...
    public byte[] getServicePkt(ServiceInfo info){
        byte[] data = new byte[PROTOCAL_LEN];
        ...
        //Log.i(TAG, "getServicePkt json:"+jsonData.toString()+" len="+jsonData.toString().length()+" checksum:"+head.checksum);
    ...
    public byte[] getResultPkt(boolean isSucc, String reason){
        byte[] data = new byte[PROTOCAL_LEN];
        
        protocalHead head = new protocalHead();
        head.head = INFO_HEAD;
        head.action = isSucc?INFO_TYPE_ACTION_SUCC:INFO_TYPE_ACTION_FAIL;
        ...
        //Log.i(TAG, "getResultPkt json:"+jsonData.toString()+" len="+jsonData.toString().length()+" checksum:"+head.checksum);
    ...
    public ServiceInfo getServiceInfo(byte[] data){
        ...
        try {
            ...
            try{
                ...
                info.info = jsonObj.getString("info");
